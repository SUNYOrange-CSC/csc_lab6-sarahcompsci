      ...
      switch (beverage)
        {
          ...
          case 'E': cout << "Please come again." << endl;
                    break;
          default: cout << "This was an invalid selection." << endl;
...
// It will inform you that it was an invalid selection and to make another one. 

// Are there any differences in the execution of the program when line 47 is replaced? Why or why not?
// There are no differences because there was no else statement to signify what would happen if "validBeverage" was not true. 
